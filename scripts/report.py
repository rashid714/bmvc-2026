...
# If you know the actual English names for your classes, replace them here!
# Otherwise, it will print Intention_0, Intention_1, etc.
INTENTION_NAMES = [f"Intention_{i}" for i in range(20)]
